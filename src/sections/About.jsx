...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("priyanshubhardwaj.cs@gmail.com");
    setHasCopied(true);
    setTimeout(() => {
      setHasCopied(false);
    }, 2000);
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-1.5xl md:text-0.8xl font-medium text-gray_gradient text-white">
                  priyanshubhardwaj.cs@gmail.com
                </p>
              </div>
            </div>
          </div>
